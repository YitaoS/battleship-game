...
public class CoordinateTest {
  ...
  public void test_row_and_col() {
    Coordinate c1 = new Coordinate(10, -40);
    assertEquals(10, c1.getRow());
    ;
    assertEquals(-40, c1.getColumn());
  }
  ...
  public void test_toString() {
    ...
    Coordinate c2 = new Coordinate(-100000, 130);
    Coordinate c3 = new Coordinate(1000, Integer.MAX_VALUE);
    Coordinate c4 = new Coordinate(Integer.MIN_VALUE, Integer.MIN_VALUE);
    assertEquals("(0, 0)", c1.toString());
    assertEquals("(-100000, 130)", c2.toString());
    assertEquals("(1000, 2147483647)", c3.toString());
    assertEquals("(-2147483648, -2147483648)", c4.toString());
  }
